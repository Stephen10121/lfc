...
<section>
    <div class="cards">
        ...
        <ServicesCard>
            <enhanced:img sizes="min(700px, 100vw)" loading="lazy" class="image-box-image" src="../assets/white.jpg" alt="A very nice looking fence." />
        </ServicesCard>
        <ServicesCard>
            <enhanced:img sizes="min(700px, 100vw)" loading="lazy" class="image-box-image" src="../assets/fence9.jpg" alt="A very nice looking fence." />
        </ServicesCard>
        <ServicesCard>
            <enhanced:img sizes="min(700px, 100vw)" loading="lazy" class="image-box-image" src="../assets/fence8.jpg" alt="A very nice looking fence." />
        </ServicesCard>
        <ServicesCard>
            <enhanced:img sizes="min(700px, 100vw)" loading="lazy" class="image-box-image" src="../assets/fence10.jpg" alt="A very nice looking fence." />
        </ServicesCard>
        <ServicesCard>
            <enhanced:img sizes="min(700px, 100vw)" loading="lazy" class="image-box-image" src="../assets/fence11.jpg" alt="A very nice looking fence." />
        </ServicesCard>
        <ServicesCard>
            <enhanced:img sizes="min(700px, 100vw)" loading="lazy" class="image-box-image" src="../assets/fence12.jpg" alt="A very nice looking fence." />
        </ServicesCard>
    </div>
</section>
