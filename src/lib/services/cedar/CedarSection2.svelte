<section>
    <div class="p2">
        <div class="image-box">
            <enhanced:img sizes="min(1280px, 100vw)" loading="lazy" class="image-box-image" src="../../assets/fence8.jpg" alt="A very nice looking fence." />
        </div>
    </div>
    <div class="p1">
        <h2 class="arimo">What's a Cedar Fence?</h2>
