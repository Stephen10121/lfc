<section>
    <enhanced:img alt="Background fence for the website." loading="lazy" role="presentation" src="../../assets/white.webp" decoding="async" class="bg-image" sizes="(min-width:1920px) 1280px, (min-width: 1080px) 940px, (min-width:250px) 300px" />
    <div class="cover" />
    <div class="text">
