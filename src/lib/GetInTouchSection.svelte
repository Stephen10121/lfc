...
<section id="contact">
    ...
    <div class="p2">
        <div class="image-box">
            <enhanced:img sizes="min(700px, 100vw)" loading="lazy" class="image-box-image" src="../lib/assets/fence7.webp" alt="A very nice looking fence." />
        </div>
    </div>
</section>
