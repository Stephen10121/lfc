<script lang="ts">
    ...
    import GallerySection1 from "$lib/gallery/GallerySection1.svelte";
    import GallerySection2 from "$lib/gallery/GallerySection2.svelte";
...
<main>
    <GallerySection1 />
    <GallerySection2 />
    <GetInTouchSection whereFrom="gallery-section" />
</main>
